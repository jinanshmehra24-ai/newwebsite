          ...
          {list.map((g, i) => (
            ...
            >
              ...
              >
                ...
                <span className="inline-flex shrink-0 items-center gap-2 border-b border-ink/40 pb-1.5 pt-1.5 text-[0.75rem] uppercase tracking-[0.12em] text-ink transition-colors duration-300 group-hover:border-violet-500">
                  Read
