...
export default function NotFound() {
  ...
  return (
    <section className="mx-auto flex min-h-[70vh] max-w-[1400px] flex-col items-center justify-center px-6 py-20 text-center sm:px-8">
      <p className="eyebrow">Error 404</p>
      <h1 className="mt-5 text-[clamp(1.6rem,3.4vw,2.7rem)] text-ink">
