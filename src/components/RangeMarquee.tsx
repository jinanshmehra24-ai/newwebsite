    ...
    >
      ...
      <div className="reveal mt-12 flex flex-wrap items-center justify-center gap-x-9 gap-y-4 px-5">
        <a
          ...
          className="group inline-flex items-center gap-2 border-b border-ink/40 pb-1.5 pt-1.5 text-[0.75rem] uppercase tracking-[0.12em] text-ink transition-colors duration-300 hover:border-gold-500"
        >
        ...
        <Link
          to="/quote"
          className="border-b border-ink/40 pb-1.5 pt-1.5 text-[0.75rem] uppercase tracking-[0.12em] text-ink transition-colors duration-300 hover:border-gold-500"
        >
          Request a Quote
        </Link>
      </div>
