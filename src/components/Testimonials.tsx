                ...
                <footer className="mt-7 border-t border-line pt-5">
                  ...
                  {product && (
                    <Link
                      ...
                      className="mt-3 inline-block border-b border-ink/30 pb-0.5 text-[0.6875rem] uppercase tracking-[0.12em] text-muted transition-colors duration-300 hover:border-gold-500 hover:text-ink"
                    >
                      {product.name}
                    </Link>
                  )}
